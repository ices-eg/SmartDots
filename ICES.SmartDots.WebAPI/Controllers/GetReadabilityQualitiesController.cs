...
//            qualityAQ1.Description = "Easy Age";
            qualityAQ1.Description = "Rings can be counted with certainty";
            ...
            qualityAQ2.Description = "Rings can be counted with difficulty and some doubt";
            ...
            qualityAQ3.Code = "AQ3";
            qualityAQ3.Description = "Rings cannot be counted, the calcified structure is considered unreadable (no age is assigned)";
            ...
            qualityAQ3_noAge.Code = "AQ3_QA";
            qualityAQ3_noAge.Description = "Unreadable or very difficult to age with acceptable precision";
