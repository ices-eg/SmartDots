<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventForm.aspx.cs" Inherits="Webinterface.manage.EventForm" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <asp:DropDownList ID="ddlTypeEvent" runat="server" DataSourceID="sqlDSTypeEvent" DataTextField="Code" DataValueField="tblCodeID"></asp:DropDownList>
                                            <asp:SqlDataSource ID="sqlDSTypeEvent" runat="server" ConnectionString="<%$ ConnectionStrings:SmartDotsCS %>" SelectCommand="SELECT [tblCodeID], [Code] FROM [tblCode] WHERE ([tblCodeGroupID] = @tblCodeGroupID)  and Code not in ('Exchange','Workshop')">
                                                <SelectParameters>
