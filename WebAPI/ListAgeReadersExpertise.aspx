<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListAgeReadersExpertise.aspx.cs" Inherits="WebInterface.ListAgeReadersExpertise" %>
    ...
    <center>
     ...
     <br />
        <table cellpadding="0" cellspacing="0" style="width: 986px;">
            ...
            <tr>
                <td colspan="2"><a href="../index.aspx">SmartDots</a> &gt; List of experties</td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
     ...
     <br />
        <asp:Label ID="lblCountryName" runat="server" Text="List of current users for :"></asp:Label>
            <asp:DropDownList ID="ddlCountries" runat="server" DataSourceID="SQLCountries" DataTextField="Description" DataValueField="tblCodeID" AutoPostBack="True">
            </asp:DropDownList>
        ...
        <asp:SqlDataSource ID="SqlDSListAgeReadersExperties" runat="server" ConnectionString="<%$ ConnectionStrings:SmartDotsCS %>" 
                SelectCommand="
                    SELECT     dbo.tblDoYouHaveAccess.SmartUser, dbo.tblAgeReadersSkills.Species, 
                                          ...
                                          REPLICATE('x', CHARINDEX('@', Email)) + RIGHT(Email, LEN(Email)  + 1 - CHARINDEX('@', Email)) as Email, dbo.tblDoYouHaveAccess.tblCodeID_Country, UPPER(LEFT(Country.Description, 1)) + LOWER(RIGHT(Country.Description, 
                    ...
                    where ( dbo.tblDoYouHaveAccess.tblCodeID_Country = @tblCodeID_Country or @tblCodeID_Country = 0 ) and Email not like '%ices.dk'" 
